...
export default function HeroSection() {
  return (
    ...
    <div className=" mx-[24px] bg-gray pb-[32px]">
      <img src="./assets/images/Postpone.svg" alt="" srcset=""  className="mt-[55px]"/>
      ...
      <button className="h-[48px] w-[100%] bg-[#294A85] text-[white] mt-[74px]  mx-[auto] block rounded-[8px]">Apply Now</button>
      </div>
    </>
  );
}
